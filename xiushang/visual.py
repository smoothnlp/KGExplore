...
def graph_visual(gram,width:int=16,height:int=16):
    """
    ...
    for k,v_lst in edges_dic.items():
        ...
        for v in v_lst:
            ...
            target_node_size = nodesize[target]
